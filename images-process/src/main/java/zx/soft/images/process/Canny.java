...
public class Canny extends Configured implements Tool {
	...
	public static class Canny_Map extends Mapper<ImageHead, RawImage, IntWritable, RawImage> {
		...
		public void map(ImageHead key, RawImage value, Context context) throws IOException, InterruptedException {
			...
			RawImage image = new RawImage(imageWidth, imageHeight, Y, Y, Y, Y, value.getCb(), value.getCr());
	...
	//	public static class Canny_Reduce extends Reducer<IntWritable, RawImage, IntWritable, IntWritable> {
	//
	//		public void setup(Context context) throws IOException {
	//		}
	//
	...
	public int run(String[] args) throws Exception {
		...
		job.setMapperClass(Canny_Map.class);
		//		job.setCombinerClass(Reduce.class);
		//		job.setReducerClass(Canny_Reduce.class);
	...
	public static void main(String[] args) throws Exception {
		int exitCode = ToolRunner.run(new Canny(), args);
